...
function AppContent() {
  ...
  const [showWhatsNew, setShowWhatsNew] = useState(() => {
    const lastSeenVersion = window.localStorage.getItem("last-seen-version");
    return user && lastSeenVersion !== "0.8.0";
  });
  ...
  const handleCloseWhatsNew = () => {
    ...
    window.localStorage.setItem("last-seen-version", "0.8.0");
  };
